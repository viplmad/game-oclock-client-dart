...
*GameFinishApi* | [**getFinishedGamesReview**](doc//GameFinishApi.md#getfinishedgamesreview) | **POST** /api/v1/games/finished/review | 
...
*GameLogsApi* | [**getPlayedGamesReview**](doc//GameLogsApi.md#getplayedgamesreview) | **POST** /api/v1/games/played/review | 
...
## Documentation For Models
 ...
 - [GameFinishedReviewDTO](doc//GameFinishedReviewDTO.md)
 - [GameLogDTO](doc//GameLogDTO.md)
 - [GamePageResult](doc//GamePageResult.md)
 - [GamePlayedReviewDTO](doc//GamePlayedReviewDTO.md)
 ...
 - [GamesFinishedReviewDTO](doc//GamesFinishedReviewDTO.md)
 - [GamesLogDTO](doc//GamesLogDTO.md)
 - [GamesPlayedReviewDTO](doc//GamesPlayedReviewDTO.md)
