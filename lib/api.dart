...
part 'model/dlc_search_result.dart';
part 'model/dlc_with_finish_dto.dart';
part 'model/dlc_with_finish_search_result.dart';
...
part 'model/game_search_result.dart';
part 'model/game_status.dart';
part 'model/game_with_finish_dto.dart';
part 'model/game_with_finish_search_result.dart';
part 'model/game_with_log_dto.dart';
part 'model/game_with_log_search_result.dart';
