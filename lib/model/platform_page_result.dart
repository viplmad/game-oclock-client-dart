    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PlatformPageResult[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PlatformPageResult[$key]" has a null value in JSON.');
        });
        return true;
      }());
