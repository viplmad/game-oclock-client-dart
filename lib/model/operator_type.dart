...
class OperatorType {
  ...
  static const null_ = OperatorType._(r'Null');
  static const notNull = OperatorType._(r'NotNull');
  ...
  OperatorType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'Null': return OperatorType.null_;
        case r'NotNull': return OperatorType.notNull;
        default:
          if (!allowNull) {
