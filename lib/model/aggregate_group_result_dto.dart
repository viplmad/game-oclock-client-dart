...
class AggregateGroupResultStringIntDTO extends AggregateGroupResultDTO<String, int> {
  /// Returns a new [AggregateGroupResultStringIntDTO] instance.
  AggregateGroupResultStringIntDTO({
    required super.key,
    required super.value,
  });
  ...
  @override
  String toString() => 'AggregateGroupResultStringIntDTO[key=$key, value=$value]';
  ...
  /// Returns a new [AggregateGroupResultStringIntDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AggregateGroupResultStringIntDTO? fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();
      ...
      assert(() {
        assert(json.containsKey(r'key'),
            'Required key "AggregateGroupResultStringIntDTO[key]" is missing from JSON.');
        assert(json[r'key'] != null,
            'Required key "AggregateGroupResultStringIntDTO[key]" has a null value in JSON.');
        assert(json.containsKey(r'value'),
            'Required key "AggregateGroupResultStringIntDTO[value]" is missing from JSON.');
        assert(json[r'value'] != null,
            'Required key "AggregateGroupResultStringIntDTO[value]" has a null value in JSON.');
        return true;
      }());

      return AggregateGroupResultStringIntDTO(
        key: mapValueOfType<String>(json, r'key')!,
        value: mapValueOfType<int>(json, r'value')!,
      );
    }
  ...
  static List<AggregateGroupResultStringIntDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <AggregateGroupResultStringIntDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AggregateGroupResultStringIntDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AggregateGroupResultStringIntDTO> mapFromJson(dynamic json) {
    final map = <String, AggregateGroupResultStringIntDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AggregateGroupResultStringIntDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AggregateGroupResultStringIntDTO-objects as value to a dart map
  static Map<String, List<AggregateGroupResultStringIntDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<AggregateGroupResultStringIntDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AggregateGroupResultStringIntDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
