...
class DLCWithFinishPageResult extends PageResultDTO<DLCWithFinishDTO> {
  ...
  bool operator ==(Object other) =>
      ...
      other is DLCWithFinishPageResult &&
  ...
  @override
  String toString() =>
      'DLCWithFinishPageResult[data=$data, page=$page, size=$size]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DLCWithFinishPageResult[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DLCWithFinishPageResult[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DLCWithFinishPageResult> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DLCWithFinishPageResult>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DLCWithFinishPageResult.listFromJson(
          entry.value,
          growable: growable,
        );
      }
