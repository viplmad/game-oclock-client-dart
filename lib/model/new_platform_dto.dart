...
class NewPlatformDTO {
  ...
  bool operator ==(Object other) =>
      ...
      other is NewPlatformDTO && other.name == name && other.type == type;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (name == null ? 0 : name!.hashCode) + (type == null ? 0 : type!.hashCode);
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "NewPlatformDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "NewPlatformDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewPlatformDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<NewPlatformDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = NewPlatformDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
