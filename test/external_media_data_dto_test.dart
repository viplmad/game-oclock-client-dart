...
// tests for ExternalMediaDataDTO
void main() {
  // final instance = ExternalMediaDataDTO();

  group('test ExternalMediaDataDTO', () {
    // String edition
    ...
    // int parentOrder
    test('to test the property `parentOrder`', () async {
      // TODO
    });
    ...
    // List<String> series (default value: const [])
