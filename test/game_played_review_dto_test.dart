...
// tests for GamePlayedReviewDTO
void main() {
  // final instance = GamePlayedReviewDTO();

  group('test GamePlayedReviewDTO', () {
    ...
    // bool firstPlayed
    test('to test the property `firstPlayed`', () async {
      // TODO
    });
    ...
    test('to test the property `longestSession`', () async {
      // TODO
    });

    // GameStreakDTO longestStreak
    test('to test the property `longestStreak`', () async {
      // TODO
    });
    ...
    // Map<String, int> totalSessionsGrouped (default value: const {})
    test('to test the property `totalSessionsGrouped`', () async {
      // TODO
    });
