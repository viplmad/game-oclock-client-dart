...
void main() {
  ...
  group('tests for PlatformsApi', () {
    // 
    //
    //Future deletePlatform(int id) async
    ...
    // 
    //
    //Future deletePlatformIcon(int id) async
    ...
    // 
    //
    //Future postPlatformIcon(int id) async
    ...
    // 
    //
    //Future putPlatformIcon(int id, String body) async
